...
/**
 * This class runs an Interval Join Query with the order [[A X C]^w1 x B]^w2 and returns the stream ABC.
 * timePropagation: The timestamp (either 'B' or 'C') that is used for the stream BC in [BC x A]^w2
 */

public class IVJ_ACB {
    ...
    public IVJ_ACB(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, DataStream<Tuple3<Integer, Integer, Long>> streamC, int lowerBound_w1, int upperBound_w1, int lowerBound_w2, int upperBound_w2, String timePropagation) {
