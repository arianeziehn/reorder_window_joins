...
public class IVJ_a_CAB {
    public static void main(String[] args) throws Exception {
        ...
        if (!parameters.has("output")) {
            outputPath = "./src/main/resources/resultIVJ_CAB.csv";
        } else {
        ...
        DataStream<Tuple6<Integer, Integer, Long, Integer, Integer, Long>> streamAC = streamC.keyBy(new UDFs.getKeyT3())
        ...
        DataStream<Tuple9<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long>> streamABC = streamAC.keyBy(new UDFs.getKeyT6())
