...
public class IVJ_a_BAC {
    public static void main(String[] args) throws Exception {
        ...
        if (!parameters.has("output")) {
            outputPath = "./src/main/resources/resultIVJ_BAC.csv";
        } else {
        ...
        DataStream<Tuple6<Integer, Integer, Long, Integer, Integer, Long>> streamAB = streamB.keyBy(new UDFs.getKeyT3())
