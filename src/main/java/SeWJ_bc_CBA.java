...
/**
 * This is class runs a Session Window Join Query with the order [[C X B]^w2 x A]^w1 and return the result stream ABC
 */

public class SeWJ_bc_CBA {
    ...
    public SeWJ_bc_CBA(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, DataStream<Tuple3<Integer, Integer, Long>> streamC, int w1Size, int w2Size, String timePropagation) {
