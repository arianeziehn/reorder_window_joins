...
/**
 * This is class runs a Session Window Join Query with the order [[B X C]^w2 x A]^w2 and return the result stream ABC (order of composed tuples for comparison).
...
public class SeWJ_BCA {
    ...
    public SeWJ_BCA(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, DataStream<Tuple3<Integer, Integer, Long>> streamC, int w1Size, int w2Size, String timePropagation) {
