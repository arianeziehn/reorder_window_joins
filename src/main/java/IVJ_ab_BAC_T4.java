 ...
 * assumption: commutative counterpart to default query, same performance
 * parameters:
 * timePropagation: The timestamp (either 'A' or 'B') that is used for the stream AB in [AB x C]^w2
 */

public class IVJ_ab_BAC_T4 {
    ...
    public IVJ_ab_BAC_T4(DataStream<Tuple4<Integer, Integer, Long, Long>> streamA, DataStream<Tuple4<Integer, Integer, Long, Long>> streamB, DataStream<Tuple4<Integer, Integer, Long, Long>> streamC, int lowerBound_w1, int upperBound_w1, int lowerBound_w2, int upperBound_w2, String timePropagation) {
    ...
    public DataStream<Tuple10<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long, Long>> run() {
        // join A B
        DataStream<Tuple7<Integer, Integer, Long, Integer, Integer, Long, Long>> streamAB = streamB
