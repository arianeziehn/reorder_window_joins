...
public class SWJ_AB_T7 {
    ...
    public SWJ_AB_T7(DataStream<Tuple7<Integer, Integer, Long, Integer, Integer, Long, Long>> streamA, DataStream<Tuple4<Integer, Integer, Long, Long>> streamB, int w1Size, int w1Slide) {
