...
public class Mixed_WJ_ABCD {
    ...
    public Mixed_WJ_ABCD(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, DataStream<Tuple3<Integer, Integer, Long>> streamC, DataStream<Tuple3<Integer, Integer, Long>> streamD, int w1Size, int w1Slide, int w2Size, int w2Slide, int w3Size, int w3Slide, String timePropagation1, String timePropagation2) {
