...
public class SWJ_bc_BCA_parameter {
    ...
    public SWJ_bc_BCA_parameter(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, DataStream<Tuple3<Integer, Integer, Long>> streamC, int w1Size, int w1Slide, int w2Size, int w2Slide, String timePropagation) {
    ...
    public DataStream<Tuple9<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long>> run() {
        ...
        // it follows w2Size < w1Size, and we want to be efficient, so we propagate C and w2Size
