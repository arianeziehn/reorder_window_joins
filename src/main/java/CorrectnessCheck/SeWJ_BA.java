...
/**
 * This is class runs a Session Window Join Query with the order [B X A]^w1 and return the result stream AB
 */

public class SeWJ_BA {
    DataStream<Tuple3<Integer, Integer, Long>> streamA;
    DataStream<Tuple3<Integer, Integer, Long>> streamB;
    Integer gap;


    public SeWJ_BA(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, int gap) {
