...
/**
 * This is class runs a Sliding Window Join Query with the order [[B X A]^w1 x C]^w2
...
public class SWJ_BA_parameter {
    ...
    public SWJ_BA_parameter(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, int w1Size, int w1Slide) {
