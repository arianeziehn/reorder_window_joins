...
public class SWJ_AB_parameter {
    ...
    public SWJ_AB_parameter(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, int w1Size, int w1Slide) {
