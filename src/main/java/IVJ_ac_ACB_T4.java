...
/**
 * This class runs an Interval Join Query with the order [[B X C]^w1 x A]^w2 and returns the stream ABC.
 * parameters:
 * timePropagation: The timestamp (either 'B' or 'C') that is used for the stream BC in [BC x A]^w2
 */

public class IVJ_ac_ACB_T4 {
    ...
    public IVJ_ac_ACB_T4(DataStream<Tuple4<Integer, Integer, Long, Long>> streamA, DataStream<Tuple4<Integer, Integer, Long, Long>> streamB, DataStream<Tuple4<Integer, Integer, Long, Long>> streamC, int lowerBound_w1, int upperBound_w1, int lowerBound_w2, int upperBound_w2, String timePropagation) {
    ...
    public DataStream<Tuple10<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long, Long>> run() {
        // join A B
        DataStream<Tuple7<Integer, Integer, Long, Integer, Integer, Long, Long>> streamAC = streamA
                ...
                }).assignTimestampsAndWatermarks(new UDFs.ExtractTimestampAC_T7(60000, timePropagation));

        DataStream<Tuple10<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long, Long>> streamABC = streamAC
                ...
                .process(new ProcessJoinFunction<Tuple7<Integer, Integer, Long, Integer, Integer, Long, Long>, Tuple4<Integer, Integer, Long, Long>, Tuple10<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long, Long>>() {
                    ...
                    public void processElement(Tuple7<Integer, Integer, Long, Integer, Integer, Long, Long> d1, Tuple4<Integer, Integer, Long, Long> d2, ProcessJoinFunction<Tuple7<Integer, Integer, Long, Integer, Integer, Long, Long>, Tuple4<Integer, Integer, Long, Long>, Tuple10<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long, Long>>.Context context, Collector<Tuple10<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long, Long>> collector) throws Exception {
                        ...
                        collector.collect(new Tuple10<>(d1.f0, d1.f1, d1.f2, d2.f0, d2.f1, d2.f2, d1.f3, d1.f4, d1.f5, maxSysTime));
                    }
                });
