...
public class SWJ3wayC_BA {
    public static void main(String[] args) throws Exception {
        ...
        Integer slideSize = parameters.getInt("ssize", 1);
        long throughput = parameters.getLong("tput", 100000);

        String outputPath;
        if (!parameters.has("output")) {
            outputPath = file.replace(".csv", "_resultSWJ_C_BA.csv");
        } else {
        ...
        DataStream<Tuple3<KeyedDataPointGeneral, KeyedDataPointGeneral, Long>> seq2 = quaStream.join(velStream)
        ...
        DataStream<Tuple3<KeyedDataPointGeneral, KeyedDataPointGeneral, KeyedDataPointGeneral>> seq3 = pm10Stream.join(seq2)
                .where(KeyedDataPointGeneral::getKey)
