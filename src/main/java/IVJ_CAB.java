...
/**
 * This class runs an Interval Join Query with the order [[C X A]^w1 x B]^w2 and returns the stream ABC.
 * timePropagation: The timestamp (either 'A' or 'C') that is used for the stream CA in [CA x B]^w2
 */

public class IVJ_CAB {
    ...
    public IVJ_CAB(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, DataStream<Tuple3<Integer, Integer, Long>> streamC, int lowerBound_w1, int upperBound_w1, int lowerBound_w2, int upperBound_w2, String timePropagation) {
    ...
    public DataStream<Tuple9<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long>> run() {
        // join A B
        DataStream<Tuple6<Integer, Integer, Long, Integer, Integer, Long>> streamCA = streamC
        ...
        DataStream<Tuple9<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long>> streamABC = streamCA
