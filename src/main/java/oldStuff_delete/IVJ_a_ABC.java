...
public class IVJ_a_ABC {
    public static void main(String[] args) throws Exception {
        ...
        if (!parameters.has("output")) {
            outputPath = "./src/main/resources/resultIVJ_ABC.csv";
        } else {
        ...
        DataStream<Tuple6<Integer, Integer, Long, Integer, Integer, Long>> streamAB = streamA.keyBy(new UDFs.getKeyT3())
        ...
        DataStream<Tuple9<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long>> streamABC = streamAB.keyBy(new UDFs.getKeyT6())
