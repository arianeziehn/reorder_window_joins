...
public class IVJ_a_C_BA {
    public static void main(String[] args) throws Exception {
        ...
        if (!parameters.has("output")) {
            outputPath = "./src/main/resources/resultIVJ_C_BA.csv";
        } else {
        ...
        DataStream<Tuple9<Integer,Integer,Long, Integer,Integer,Long,Integer,Integer,Long>> streamABC = streamC.keyBy(new UDFs.getKeyT3())
                .intervalJoin(streamAB.keyBy(new UDFs.getKeyT6()))
