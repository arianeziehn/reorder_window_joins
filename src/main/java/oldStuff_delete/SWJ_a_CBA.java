...
public class SWJ_a_CBA {
    public static void main(String[] args) throws Exception {
        ...
        // we except minutes
        Integer w1Size = parameters.getInt("w1size", 15);
        Integer w1Slide = parameters.getInt("s1size", 1);
        Integer w2Size = parameters.getInt("w1size", 15);
        Integer w2Slide = parameters.getInt("s1size", 1);
        ...
        if (!parameters.has("output")) {
            outputPath = "./src/main/resources/resultSWJ_CBA.csv";
        } else {
