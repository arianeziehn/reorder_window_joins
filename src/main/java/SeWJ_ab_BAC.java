...
/**
 * This is class runs a Session Window Join Query with the order [[B X A]^w1 x C]^w2 and return the result stream ABC
 */

public class SeWJ_ab_BAC {
    ...
    public SeWJ_ab_BAC(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, DataStream<Tuple3<Integer, Integer, Long>> streamC, int w1Size, int w2Size, String timePropagation) {
