...
public class IVJCluster {
    public static void main(String[] args) throws Exception {
        ...
        // we except minutes
        Integer w1lB = -parameters.getInt("w1lB", 10);
        Integer w1uB = parameters.getInt("w1uB", 20);
        Integer w2lB = -parameters.getInt("w2lB", 10);
        Integer w2uB = parameters.getInt("w2uB", 20);
