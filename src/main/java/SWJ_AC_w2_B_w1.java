...
/**
 * This class runs a Sliding Window Join Query with the order [[A X C]^w2 x B]^w1 and returns the stream ABC.
 * timePropagation: The timestamp (either 'A' or 'C') that is used for the stream AC in [AC x B]^w1
 */

public class SWJ_AC_w2_B_w1 {
    ...
    public SWJ_AC_w2_B_w1(DataStream<Tuple3<Integer, Integer, Long>> streamA, DataStream<Tuple3<Integer, Integer, Long>> streamB, DataStream<Tuple3<Integer, Integer, Long>> streamC, int w1Size, int w1Slide, int w2Size, int w2Slide, String timePropagation) {
