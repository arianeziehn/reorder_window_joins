...
public class IVJ_AB_T4 {
    ...
    public IVJ_AB_T4(DataStream<Tuple4<Integer, Integer, Long, Long>> streamA, DataStream<Tuple4<Integer, Integer, Long, Long>> streamB, int lowerBound, int upperBound) {
