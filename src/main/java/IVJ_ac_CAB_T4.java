...
public class IVJ_ac_CAB_T4 {
    ...
    public IVJ_ac_CAB_T4(DataStream<Tuple4<Integer, Integer, Long, Long>> streamA, DataStream<Tuple4<Integer, Integer, Long, Long>> streamB, DataStream<Tuple4<Integer, Integer, Long, Long>> streamC, int lowerBound_w1, int upperBound_w1, int lowerBound_w2, int upperBound_w2, String timePropagation) {
    ...
    public DataStream<Tuple10<Integer, Integer, Long, Integer, Integer, Long, Integer, Integer, Long, Long>> run() {
        // join A B
        DataStream<Tuple7<Integer, Integer, Long, Integer, Integer, Long, Long>> streamAC = streamC
                .keyBy(new UDFs.getKeyT4())
                .intervalJoin(streamA.keyBy(new UDFs.getKeyT4()))
