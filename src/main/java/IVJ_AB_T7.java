...
public class IVJ_AB_T7 {
    ...
    public IVJ_AB_T7(DataStream<Tuple7<Integer, Integer, Long, Integer, Integer, Long, Long>> streamA, DataStream<Tuple4<Integer, Integer, Long, Long>> streamB, int lowerBound, int upperBound) {
