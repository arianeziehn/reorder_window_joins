...
/**
 * This is class runs a Sliding Window Join Query with the order [[C X A]^w2 x B]^w1
 * expectation: same performance as ACB
 * parameters:
 * Run with these parameters:
 * --input ./src/main/resources/QnV_R2000070.csv
 */

public class SWJ_a_CAB {
    public static void main(String[] args) throws Exception {
        ...
        if (!parameters.has("output")) {
            outputPath = "./src/main/resources/resultSWJ_CAB.csv";
        } else {
